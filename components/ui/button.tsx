...
const buttonVariants = cva(
  [
    'group/button focus-visible:border-ring focus-visible:ring-ring/50',
    'aria-invalid:border-destructive aria-invalid:ring-destructive/20',
    'dark:aria-invalid:border-destructive/50',
    'dark:aria-invalid:ring-destructive/40 inline-flex shrink-0',
    'items-center justify-center rounded-lg border border-transparent',
    'bg-clip-padding text-sm font-medium whitespace-nowrap transition-all',
    'outline-none select-none focus-visible:ring-3',
    'active:not-aria-[haspopup]:translate-y-px',
    'disabled:pointer-events-none disabled:opacity-50 aria-invalid:ring-3',
  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        secondary: [
          'bg-secondary text-secondary-foreground aria-expanded:bg-secondary',
