    ...
    <CommandPrimitive.Item
      ...
      className={cn(
        [
          ...
          'data-selected:*:[svg]:text-foreground group/command-item relative',
          ...
          'data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none',
    ...
    <span
      ...
      className={cn(
        [
          ...
          'group-data-selected/command-item:text-foreground ms-auto text-xs',
          'tracking-widest',
        ].join(' '),
        className,
      )}
