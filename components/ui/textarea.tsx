    ...
    <textarea
      ...
      className={cn(
        [
          ...
          'dark:aria-invalid:ring-destructive/40 flex field-sizing-content',
          'min-h-16 w-full rounded-lg border bg-transparent px-2.5 py-2',
          'text-base transition-colors outline-none focus-visible:ring-3',
