    ...
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        [
          ...
          'data-open:bg-accent data-open:text-accent-foreground flex',
          'cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 text-sm',
          'outline-hidden select-none data-inset:pl-7',
    ...
    <MenuPrimitive.RadioItem
      ...
      className={cn(
        [
          'focus:bg-accent focus:text-accent-foreground',
          'focus:**:text-accent-foreground relative flex cursor-default',
          'items-center gap-1.5 rounded-md py-1 ps-1.5 pe-8 text-sm',
          'outline-hidden select-none data-disabled:pointer-events-none',
          'data-disabled:opacity-50 data-inset:ps-7 [&_svg]:pointer-events-none',
          "[&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        ].join(' '),
        className,
      )}
    ...
    <span
      ...
      className={cn(
        [
          ...
          'group-focus/dropdown-menu-item:text-accent-foreground ml-auto text-xs',
          'tracking-widest',
        ].join(' '),
        className,
      )}
